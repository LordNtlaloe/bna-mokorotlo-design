...
const SalesOverviewChart = () => {
  ...
  return (
    <motion.div
      className="bg-[#1D1D1D] bg-opacity-50 backdrop-blur-md shadow-sm shadow-white rounded-xl p-6"
      initial={{ opacity: 1, y: 20 }}
      animate={{ opacity: 1, y: 0 }}
      transition={{ delay: 0.2 }}
    >
      <h2 className="text-lg font-medium mb-4 text-white">Sales Overview</h2>
      <div className="h-80">
