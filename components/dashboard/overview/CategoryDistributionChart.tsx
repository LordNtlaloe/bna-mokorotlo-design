...
const CategoryDistributionChart = () => {
        ...
        datasets: [
            {
                ...
                backgroundColor: ["#202022"], // Light gray color for empty state
                hoverOffset: 10,
            },
        ],
    };
    ...
    return (
        <motion.div
            className="bg-[#1D1D1D] bg-opacity-50 text-white backdrop-blur-md shadow-sm shadow-white rounded-xl p-6"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.3 }}
        >
            <h2 className="text-lg font-medium mb-4 text-white">Category Distribution</h2>
            <div className="h-80">
