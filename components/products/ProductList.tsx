    ...
    <main className="py-8 rounded-lg">
      <div className="mx-auto max-w-full px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8">
          <h2 className="font-bold text-2xl sm:text-4xl text-[#F20707]">
            {title}
          </h2>
        </div>
        ...
        {isLoading ? (
          ...
          >
            {uniqueProducts.map((product: any) => {
              ...
              return (
                <SwiperSlide key={product._id} className="rounded-xl bg-[#1D1D1D] p-4 hover:shadow-xl transition-shadow duration-300">
