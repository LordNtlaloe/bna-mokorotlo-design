    ...
    <main className="py-2">
        ...
        <div className="flex justify-end pr-2 mt-2">
          <button
            className={`transition-all flex gap-1 items-center px-2 py-1 rounded ${
              userCanRate
                ? "bg-[#F20707]-700 text-white"
                : "bg-white border border-[#F20707] text-[#F20707] cursor-not-allowed"
            }`}
      ...
      {showRatingComment && (
        ...
        >
          ...
          />
          <button className="text-white bg-[#F20707] mx-2 my-1 rounded py-1 px-2 hover:bg-[#F20707] transition-all place-self-end mt-2 flex items-center gap-1">
            <Save size={16} />
            <span>Submit</span>
          </button>
        </form>
